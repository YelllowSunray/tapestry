...
interface MemoriesStatusFormProps {
  onPostAdded?: () => void;
}

export default function MemoriesStatusForm({ onPostAdded }: MemoriesStatusFormProps) {
  ...
  const categories = [
    {
      name: 'tended',
      emoji: '🌱',
      description: 'Carefully nurtured memories'
    },
    {
      name: 'milestones',
      emoji: '⭐',
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <textarea
              ...
              placeholder="Tended memories, personal milestones, emotional roots..."
              className="w-full p-4 text-lg bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-orange-500 focus:border-transparent resize-none"
              rows={3}
