...
interface StemStatusFormProps {
  onPostAdded?: () => void;
}

export default function StemStatusForm({ onPostAdded }: StemStatusFormProps) {
  ...
  const categories = [
    ...
    },
    {
      name: 'skills',
      emoji: '🔧',
      description: 'New abilities and competencies'
    },
    {
      name: 'structure',
      emoji: '🏗️',
      description: 'Building habits and systems'
    }
  ];
        ...
        <div className="flex items-start space-x-3">
          ...
          <div className="flex-1">
            <textarea
              ...
              placeholder="Growth, skill-building, structure..."
